    ...
    var paint = {
        ...
        bind: function() {
            ...
            this.canvas['on' + t.StartEvent] = function(e) {
                ...
                var _x = touch.clientX - touch.target.offsetLeft-this.getBoundingClientRect().left; //鼠标在画布上的x坐标，以画布左上角为起点 
                var _y = touch.clientY - touch.target.offsetTop-this.getBoundingClientRect().top; //鼠标在画布上的y坐标，以画布左上角为起点 
                console.log(touch.clientX);
                console.log(touch.target.offsetLeft);
                if (t.isEraser) {
        ...
        resetEraser: function(_x, _y, touch) { /*使用橡皮擦-提醒*/
            var t = this;
